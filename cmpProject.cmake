...
if(NOT DEFINED CMP_STRING_CLASS)
    set(CMP_STRING_CLASS "QString")
endif()

if(NOT DEFINED CMP_STRING_INCLUDE)
...
if(${CMP_GENERATE_VERSION_STRING})
    ...
    cmpRevisionString(GENERATED_HEADER_FILE_PATH "${CMP_VERSION_HEADER_FILE_NAME}"
                      ...
                      STRING_CLASS "${CMP_STRING_CLASS}"
                      STRING_INCLUDE "${CMP_STRING_INCLUDE}"
    )
endif()

set(CMP_GENERATED_HEADERS 
  "${CMP_HEADER_DIR}/${CMP_CONFIGURATION_FILE_NAME}"
  "${CMP_HEADER_DIR}/${CMP_TYPES_FILE_NAME}"
  "${CMP_HEADER_DIR}/${CMP_VERSION_HEADER_FILE_NAME}"
)
set(CMP_GENERATED_SOURCES 
  "${CMP_HEADER_DIR}/${CMP_VERSION_SOURCE_FILE_NAME}"
)

cmp_IDE_GENERATED_PROPERTIES("Generated" ${CMP_GENERATED_HEADERS} ${CMP_GENERATED_SOURCES})
